...
if(isset($_POST['submit'])){
    ...
    $sql = "insert into admin(`firstname`,`phonenumber`,`email`,`password`,`address`,`image`) values('$firstname','$phonenumber','$email','$password','$address','$imagename')";
...
<html>
    ...
    <body>
        <div class="login-title">
            <h1>Registration</h1>
            <h2>Insert all information carefully</h2>
        </div>
